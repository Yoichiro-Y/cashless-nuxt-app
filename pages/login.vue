    ...
    <div>
        ...
        <div class="mt-5 py-6 flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
              ...
              <div class="w-full p-8 lg:w-1/2">
                  <p class="text-xl text-gray-600 text-center">ログイン</p>
                  ...
                  <form @submit.prevent="pressed">
                    ...
                    <div class="mt-8">
                        <button type="submit" class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">ログイン</button>
                    </div>
                  </form>
                  <div class="error" v-if="error">{{ error.message }}</div>
                  <div class="mt-4 flex items-center justify-between">
                      <span class="border-b w-1/5 md:w-1/4"></span>
                      <a href="/signup" class="text-xs text-gray-500 uppercase">または 新規登録</a>
                      <span class="border-b w-1/5 md:w-1/4"></span>
                  </div>
              </div>
          </div>
